export const about_us = {
  title: "About Drake Threads",
  text1:
    "Welcome to Drake Threads, where fashion becomes a bold statement of individuality, merging the nostalgic aesthetics of the Y2K era with the vibrant, futuristic allure of Frutiger Aero. Our brand is more than just clothing—it’s a celebration of the dynamic styles and cultural shifts that shaped the early 2000s. By blending bold colors, sleek gradients, and playful, expressive designs, we bring the best of these groundbreaking aesthetics into the modern day, offering a unique twist on timeless trends.",
  text2:
