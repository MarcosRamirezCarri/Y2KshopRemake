...
if(path === '/products')
  return (
    <div className="flex flex-col bg-[#00080a]  px-4 py-1 rounded-br-2xl rounded-bl-2xl absolute left-[50%] lg:left-0 lg:top-3 lg:translate-x-0 lg:translate-y-0 translate-x-[-50%] w-[80%] translate-y-[100%] self-center lg:relative lg:w-[40%] ">
